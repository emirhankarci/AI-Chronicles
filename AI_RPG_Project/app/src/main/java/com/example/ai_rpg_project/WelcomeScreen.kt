...
private fun WelcomText() {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(
            ...
            style = TextStyle(
                shadow = Shadow(
                    color = Color.Black, // Siyah gölge
                    offset = Offset(2f, 2f), // Gölge offseti
                    blurRadius = 3f // Gölgenin bulanıklığı
                )
            )
        )
        ...
        Text(
            ...
            style = TextStyle(
                shadow = Shadow(
                    color = Color.Black, // Siyah gölge
                    offset = Offset(1f, 1f), // Gölge offseti
                    blurRadius = 2f // Gölgenin bulanıklığı
                )
            )
        )
...
private fun GameMenu(
    ...
    val purpleGradient = listOf(Color(0xFF8E2DE2), Color(0xFF4A00E0)) // Purple-to-Black
    val grayGradient = listOf(Color(0xFF2C2C2C), Color(0xFF8E8E8E))  // Dark Gray → Light Gray
...
fun WelcomeScreenPreview() {
    // Sahte bir NavController oluşturuyoruz
